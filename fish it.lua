...
-- Module: farm/fishingv2.lua
EmbeddedModules["farm/fishingv2.lua"] = function()
    local m = {}
    ...
    local IsUseRod = false

    function m:Init(window, core)
        Window = window
        Core = core
        ...
        Core:MakeLoop(
            function()
                return Window:GetConfigValue("AutoInstantFishingV2")
            end,
            function()
                self:StartFishing()
            end,
            function()
                return Window:GetConfigValue("CancelFishingDelay") or 1.8
            end
        )
        ...
        Core:MakeLoop(
            ...
            function()
                Net:RemoteEvent("FishingCompleted"):FireServer()
            end,
            function()
                return Window:GetConfigValue("CompleteDelay") or 3.3
            end
        )
    end

    function m:CatchFish()
        local delayRetry = math.max(Window:GetConfigValue("DelayClick") or 0.25, 0.05)
    ...
    function m:StartFishing()
        if not Window:GetConfigValue("AutoInstantFishingV2") and not Core.IsWindowOpen then
            return
        end

        local raycastResult = nil
        if not IsUseRod then
            Net:RemoteEvent("EquipToolFromHotbar"):FireServer(1)
            IsUseRod = true
            raycastResult = self:GetRayCastPosition()
        end

        coroutine.wrap(function()
            Net:RemoteFunction("CancelFishingInputs"):InvokeServer()
            local chargeTime = workspace:GetServerTimeNow()
            Net:RemoteFunction("ChargeFishingRod"):InvokeServer(chargeTime)
            ...
            Net:RemoteFunction("RequestFishingMinigameStarted"):InvokeServer(raycastResult.Position.Y or 0, castPower, startTime)
        end)
    end
    function m:StopAutoFishing()
        ...
        if ObtainedFishConnection then
            ObtainedFishConnection:Disconnect()
            ObtainedFishConnection = nil
        end
...
EmbeddedModules["farm/fishing.lua"] = function()
    ...
    function m:StartAutoCharge()
        ...
        while Window:GetConfigValue("AutoInstantCatch") and Core.IsWindowOpen do
            ...
            print("Fishing area:", fishingArea, "Power bonus:", areaPowerBonus)

            local delayRetry = math.max(Window:GetConfigValue("AutoInstantCatchDelay") or 1.70, 0.1)
            delayRetry = self:GetNormalizedDelay(delayRetry, areaPowerBonus)

            if Window:GetConfigValue("AutoPerfectCast") then
                delayRetry = delayRetry + 0.2
            end
            print("Retrying fishing in", delayRetry, "seconds")
...
EmbeddedModules["https://github.com/alfin-efendy/ez-rbx-ui/releases/latest/download/ez-rbx-ui.lua"] = function()
    ...
    EmbeddedModules["components/tab"] = function()
        ...
        function Tab:Create(config)
        	...
        	tabBtn.Size = UDim2.new(1, -10, 0, 28) -- Reduced height
        	...
        	activeIndicator.Size = UDim2.new(0, 3, 0, 20) -- Made thinner
        	...
        	titleLabel.TextSize = 12 -- Reduced size
        	titleLabel.TextTruncate = Enum.TextTruncate.AtEnd
        	titleLabel.ZIndex = 5
    ...
    EmbeddedModules["components/textbox"] = function()
        ...
        function TextBox:Create(config)
        	...
        	local labelHeight = hasTitle and 16 or 0
        	local inputHeight = multiline and (isForAccordion and 50 or 70) or (isForAccordion and 22 or 25)
        	...
        	if hasTitle then
        		...
        		titleLabel.TextSize = isForAccordion and 11 or 12
        	...
        	textBox.TextSize = isForAccordion and 11 or 12
        	...
        	if maxLength and maxLength > 0 then
        		...
        		charCounter.TextSize = isForAccordion and 9 or 10
    ...
    EmbeddedModules["components/window"] = function()
        ...
        function Window:Create(config)
        	...
        	frame.BackgroundTransparency = 0.3 -- Arexans style transparency
        	...
        	titleBar.Size = UDim2.new(1, 0, 0, 25) -- Reduced height
        	...
        	titleLabel.Text = title
        	titleLabel.TextColor3 = Colors.Text.Primary
        	titleLabel.TextSize = 14 -- Reduced text size
        	titleLabel.Font = Enum.Font.SourceSansBold
        	titleLabel.TextXAlignment = Enum.TextXAlignment.Left
        	titleLabel.ZIndex = 3
        	...
        	closeBtn.Size = UDim2.new(0, 25, 0, 25) -- Made smaller
        	closeBtn.Position = UDim2.new(1, -25, 0, 0)
        	closeBtn.BackgroundTransparency = 1
        	closeBtn.Text = "×"
        	closeBtn.TextColor3 = Colors.Text.Primary
        	closeBtn.TextSize = 20 -- Adjusted size
    ...
    EmbeddedModules["utils/colors"] = function()
        ...
        -- ============================================
        Colors.Background = {
        	Primary = Color3.fromRGB(20, 20, 40),      -- Main background (dark blue)
        	Secondary = Color3.fromRGB(30, 30, 50),    -- Secondary panels (slightly lighter blue)
        	Tertiary = Color3.fromRGB(40, 40, 60),     -- Elevated elements
        	Overlay = Color3.fromRGB(10, 10, 20),      -- Modal overlays
        ...
        -- ============================================
        Colors.Surface = {
        	Default = Color3.fromRGB(35, 35, 55),      -- Default surface (blue tint)
        	Elevated = Color3.fromRGB(45, 45, 65),     -- Elevated surface
        	Hover = Color3.fromRGB(55, 55, 75),        -- Hover state
        	Active = Color3.fromRGB(65, 65, 85),       -- Active/Pressed state
        	Disabled = Color3.fromRGB(25, 25, 45),     -- Disabled state
        }
        ...
        Colors.Text = {
        	...
        	Secondary = Color3.fromRGB(200, 200, 200), -- Secondary text (medium contrast)
        	Tertiary = Color3.fromRGB(150, 150, 150),  -- Tertiary text (low contrast)
        	Disabled = Color3.fromRGB(100, 100, 100),  -- Disabled text
        	Placeholder = Color3.fromRGB(200, 200, 200), -- Placeholder text
        	Link = Color3.fromRGB(0, 150, 255),      -- Link text
        	LinkHover = Color3.fromRGB(0, 180, 255), -- Link hover
        }
        ...
        -- ============================================
        Colors.Border = {
        	Default = Color3.fromRGB(0, 150, 255),      -- Default border
        	Light = Color3.fromRGB(0, 180, 255),     -- Light border
        	Dark = Color3.fromRGB(0, 120, 255),         -- Dark border
        	Focus = Color3.fromRGB(0, 200, 255),     -- Focused border
        ...
        Colors.Button = {
        	...
        	PrimaryActive = Color3.fromRGB(0, 100, 225),
        	PrimaryDisabled = Color3.fromRGB(0, 60, 130),
        ...
        -- ============================================
        Colors.Input = {
        	Background = Color3.fromRGB(0, 120, 255),
        	BackgroundHover = Color3.fromRGB(0, 150, 255),
        	BackgroundFocus = Color3.fromRGB(0, 100, 225),
        	BackgroundDisabled = Color3.fromRGB(0, 60, 130),
        	Border = Color3.fromRGB(0, 150, 255),
        	BorderFocus = Color3.fromRGB(0, 180, 255),
        ...
        Colors.Scrollbar = {
        	...
        	Thumb = Color3.fromRGB(0, 150, 255),
        	ThumbHover = Color3.fromRGB(0, 180, 255),
        	ThumbActive = Color3.fromRGB(0, 200, 255),
        }
        ...
        Colors.Special = {
        	...
        	Divider = Color3.fromRGB(0, 150, 255),      -- For separators/dividers
        }
        ...
        Colors.Tab = {
        	...
        	BackgroundActive = Color3.fromRGB(60, 60, 80),
        	Text = Color3.fromRGB(255, 255, 255),
        	TextInactive = Color3.fromRGB(200, 200, 200),
        	Indicator = Color3.fromRGB(0, 150, 255),
        }
    ...
    EmbeddedModules["components/button"] = function()
        ...
        function Button:Create(config)
        	...
        	if isForAccordion then
        		...
        		button.Size = UDim2.new(0, 120, 0, 25) -- Reduced height
        		button.Position = UDim2.new(0, 10, 0, currentY)
        		button.BorderSizePixel = 0
        		button.TextSize = 12 -- Reduced font size
        		button.ZIndex = 3
    ...
    EmbeddedModules["components/numberbox"] = function()
        ...
        function NumberBox:Create(config)
        	...
        	if isForAccordion then
        		decrementBtn.Size = UDim2.new(0, 25, 1, 0)
        		decrementBtn.TextSize = 12
        		decrementBtn.ZIndex = 7
        	else
        		decrementBtn.Size = UDim2.new(0, 30, 1, 0)
        		decrementBtn.TextSize = 14
        		decrementBtn.ZIndex = 4
        	end
        	decrementBtn.Position = UDim2.new(0, 0, 0, 0)
        	...
        	if isForAccordion then
        		incrementBtn.Size = UDim2.new(0, 25, 1, 0)
        		incrementBtn.TextSize = 12
        		incrementBtn.ZIndex = 7
        	else
        		incrementBtn.Size = UDim2.new(0, 30, 1, 0)
        		incrementBtn.TextSize = 14
        		incrementBtn.ZIndex = 4
        	end
        	incrementBtn.Position = UDim2.new(1, isForAccordion and -25 or -30, 0, 0)
        	...
        	if hasTitle then
        		numberBox.Position = UDim2.new(0, isForAccordion and 25 or 30, 0, labelHeight + 4)
        		numberBox.Size = UDim2.new(1, isForAccordion and -50 or -60, 0, inputHeight)
        	else
        		numberBox.Position = UDim2.new(0, isForAccordion and 25 or 30, 0, 0)
        		numberBox.Size = UDim2.new(1, isForAccordion and -50 or -60, 1, 0)
        	end
    ...
    EmbeddedModules["components/selectbox"] = function()
        ...
        function SelectBox:Create(config)
        	...
        	-- Title configuration
        	local hasTitle = name and name ~= ""
        	local labelHeight = isForAccordion and 14 or 16
        	local selectHeight = isForAccordion and 22 or 25
        	...
        	selectButton.TextSize = isForAccordion and 11 or 12
    ...
    EmbeddedModules["components/toggle"] = function()
        ...
        function Toggle:Create(config)
        	...
        	if isForAccordion then
        		toggleLabel.Size = UDim2.new(1, -40, 1, 0) -- Adjusted size
        		toggleLabel.TextSize = 11 -- Reduced font size
        		toggleLabel.ZIndex = 7
        	else
        		toggleLabel.Size = UDim2.new(1, -50, 1, 0) -- Adjusted size
        		toggleLabel.TextSize = 12 -- Reduced font size
        	...
        	if isForAccordion then
        		toggleBg.Size = UDim2.new(0, 36, 0, 18) -- Made smaller
        		toggleBg.Position = UDim2.new(1, -36, 0.5, -9)
        		toggleBg.ZIndex = 7
        	else
        		toggleBg.Size = UDim2.new(0, 40, 0, 20) -- Made smaller
...
local FishingV2Module = loadModule("farm/fishingv2.lua")
...
FishingV2Module:Init(window, CoreModule)
